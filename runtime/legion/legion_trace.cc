...
namespace Legion {
  namespace Internal {
    ...
    //--------------------------------------------------------------------------
    {
      // FIXME: we will ignore this flag for now not to make Elliott's scripts
      //        get confused
      ...
      // After the following fence elision, the invariant is that
      // the generator of events[idx] is instructions[gen[idx]].
